...
data class AladinBookDetailResponse internal constructor(
...
@JsonIgnoreProperties(ignoreUnknown = true)
data class AladinDetailItem internal constructor(
    @JsonProperty("title") val title: String,
    @JsonProperty("link") val link: String,
    ...
    @JsonProperty("subInfo") val subInfo: AladinDetailSubInfo
)

@JsonIgnoreProperties(ignoreUnknown = true)
data class AladinDetailSubInfo(
